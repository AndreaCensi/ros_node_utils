...
htmlhelp_basename = 'ros_node_utils_doc'
...
latex_documents = [
  ('index', 'ros_node_utils.tex', u'ROSNodeUtils Documentation',
...
man_pages = [
    ('index', 'ros_node_utils', u'ROSNodeUtils Documentation',
     [u'Andrea Censi'], 1)
]
